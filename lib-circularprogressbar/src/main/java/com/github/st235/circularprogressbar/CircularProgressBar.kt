package com.github.st235.circularprogressbar
...
import st235.com.github.circularprogressbar.R
import com.github.st235.circularprogressbar.utils.dp
...
class CircularProgressBar @JvmOverloads constructor(
    ...
    init {
        ...
        backgroundProgressColor = typedArray.getColor(
            R.styleable.CircularProgressBar_cpb_progressBackgroundColor,
            Color.GRAY
        )
        foregroundProgressColor =
            typedArray.getColor(R.styleable.CircularProgressBar_cpb_progressBarColor, Color.BLACK)

        progressBarThickness =
            typedArray.getDimension(R.styleable.CircularProgressBar_cpb_progressBarThickness, 4F.dp)
        progressIndicatorSize = typedArray.getDimension(
            R.styleable.CircularProgressBar_cpb_progressIndicatorSize,
            10F.dp
        )
